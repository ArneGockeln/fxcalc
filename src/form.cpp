...
namespace fxcalc {
	Form::Form(QWidget* parent): QWidget(parent) {
		...
		QLabel* label_pips              = new QLabel(tr("SL / TP, pips"));
		...
		layout_inputs->addWidget(label_risk_percent, 3, 0);
		layout_inputs->addWidget(edit_risk_percent_, 3, 1);
		layout_inputs->addWidget(label_pips, 4, 0);
		layout_inputs->addLayout(layout_pips, 4, 1);
		layout_inputs->addWidget(label_commission, 5, 0);
		layout_inputs->addWidget(edit_commission_, 5, 1);
		layout_inputs->addWidget(label_instrument, 6, 0);
		layout_inputs->addLayout(layout_refresh_rates, 6, 1);
		layout_inputs->addWidget(label_instrument_rate_, 7, 0);
		layout_inputs->addWidget(edit_instrument_rate_, 7, 1);
		// - pos_size
		...
		layout_pos_size->addWidget(label_commissions, 3, 0);
		layout_pos_size->addWidget(label_commission_, 3, 1);
		layout_pos_size->addWidget(label_units, 4, 0);
		layout_pos_size->addLayout(layout_copy_units, 4, 1);
		layout_pos_size->addWidget(label_lots, 5, 0);
		layout_pos_size->addLayout(layout_copy_lots, 5, 1);
		// - margins
